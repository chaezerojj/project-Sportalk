  ...
  return (
    <div className="stadium-container">
      ...
      <section className="main-content">
        ...
        <div className="center-column">
          <img src={`${process.env.PUBLIC_URL}/samsungst.png`} alt="대구 삼성 라이온즈 파크" className="stadium-image" />
        </div>
        <div className="center-column">
          <img src={`${process.env.PUBLIC_URL}/slogan3.png`} alt="슬로건" className="stadium-image" />
        </div>
      </section>
